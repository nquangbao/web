...
<head>
  ...
  <link rel="stylesheet" href="css/vendor/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="css/vendor/icheck-bootstrap.min.css">
  <!-- JQVMap -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../login/logout.php" class="nav-link">Đăng xuất</a>
      </li>
    </ul>
